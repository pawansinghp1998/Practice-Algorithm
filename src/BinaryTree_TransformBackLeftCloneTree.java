...
public class BinaryTree_TransformBackLeftCloneTree {
    ...
    public static Node TransformBackLeftCloneTree(Node node) {
        if(node==null)
            return null;
        Node lct=TransformBackLeftCloneTree(node.left.left);
        Node rct=TransformBackLeftCloneTree(node.right);
        node.left=lct;
        node.right=rct;
        return node;
    }
        ...
        Node normalroot=TransformBackLeftCloneTree(leftclonetreeroot);
            display(normalroot);
        }
    }
